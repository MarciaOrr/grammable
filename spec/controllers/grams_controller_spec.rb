...
RSpec.describe GramsController, type: :controller do
  ...
  describe 'grams#new action' do
    it 'sshould require users to be logged in' do
      get :new
  ...
  describe 'grams#edit action' do
    it "should only allow the gram's creator to edit a gram" do
      gram = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
  ...
  describe 'grams#update action' do
    it "should only allow the gram's creator to update a gram" do
      gram = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
  ...
  describe 'grams#destroy action' do
    it "should only allow the gram's creator to destroy a gram" do
      gram = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
